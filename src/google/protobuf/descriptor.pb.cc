...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.FileDescriptorProto)
  ...
  // repeated int32 public_dependency = 10;
  {
    std::size_t data_size = ::_pbi::WireFormatLite::Int32Size(
        this->_impl_.public_dependency_)
    ;
...
void FileDescriptorProto::InternalSwap(FileDescriptorProto* other) {
  ...
  _impl_.dependency_.InternalSwap(
...
void DescriptorProto::InternalSwap(DescriptorProto* other) {
  ...
  _impl_.reserved_name_.InternalSwap(
...
::uint8_t* FieldOptions::_InternalSerialize(
  ...
  for (int i = 0, n = this->_impl_.targets_.size(); i < n; ++i) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
        19, static_cast<::google::protobuf::FieldOptions_OptionTargetType>(this->_impl_.targets_.Get(i)),
        target);
  }
...
void SourceCodeInfo_Location::InternalSwap(SourceCodeInfo_Location* other) {
  ...
  _impl_.leading_detached_comments_.InternalSwap(
